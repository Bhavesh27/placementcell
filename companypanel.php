...
include('config.php');
session_start(); 
$query="SELECT * FROM companydetails WHERE email = '".$_SESSION['username']."' AND password = '".$_SESSION['password']."'";
...
<link rel="shortcut icon" href="placementcell_icon.png">
    ...
    div { width: 100%; height: 30%; float: left; background: #5C5659    ;}
   </style>
</head>
<body>
<div>
    <form method="POST" action="companypanel.php">
...
$result = mysqli_query($conn,$query);
echo "<center><h1>Student Resumes</h1><br>";
